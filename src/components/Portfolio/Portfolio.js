      ...
      <section className="portfolio">
         ...
         <ul className="portfolio__list">
            <li className="portfolio__item">
               <a href="https://github.com/AnatolySidash/how-to-learn" target="blank" className="portfolio__name-link">
            ...
            <li className="portfolio__item">
               <a href="https://github.com/AnatolySidash/russian-travel" target="blank" className="portfolio__name-link">
            ...
            <li className="portfolio__item">
               <a href="https://github.com/AnatolySidash/react-mesto-api-full-gha" target="blank" className="portfolio__name-link">
